...
class ReportsController extends Controller
{
     ...
     */
    public function dailyReport($userId, Request $request)
    {
     ...
     */
    public function summaryReport($userId, Request $request)
    {
     ...
     * Weight Trend
     */
    public function weightTrend($userId, Request $request)
    {
        $start = Carbon::parse($request->query('start_date'));
        $end = Carbon::parse($request->query('end_date'));
     ...
     */
    public function goalsComparison($userId, Request $request)
    {
        $start = Carbon::parse($request->query('start_date'));
        $end = Carbon::parse($request->query('end_date'));
